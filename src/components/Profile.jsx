  ...
  return (
    <div className={classes['profile']}>
      <div className={classes['profile-data']}>
        <img className={classes['profile-image']} src={image} alt="User avatar" />
      ...
      <ul className={classes['profile-stats']}>
        {Object.entries(stats).map(([statName, statValue]) => (
          <li className={classes['profile-stats-item']} key={statName}>
            <span className={classes['profile-stats-item-title']}>{statName}</span>
            <span className={classes['profile-stats-item-quantity']}>{statValue}</span>
          </li>
        ))}
      </ul>
    </div>
